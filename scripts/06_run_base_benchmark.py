...
from sidsearch_lora_lab.evaluation.benchmark import run_rule_engine_benchmark
...
def main() -> None:
    ...
    result = run_rule_engine_benchmark(Path("benchmarks/heldout.jsonl"), Path("results/base_rule_engine_results.json"), generator)
